export default function shuffle(txt) {
	...
	const chars = "aÃ bcdeÃ¨Ã©fghiÃ¬jklmnoÃ²pqrstuÃ¹Ã¼vwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789%/|\\()#?!\"'â€œâ€â€˜â€™;:Ï€*+â€¢â€”-_,. ";
	...
	counts[0] = minHeight;
	for (i = 1; i < width; i++) {
		counts[i] = Math.floor(Math.random()*(maxHeight-minHeight))+minHeight;
	}
